...
<link rel="stylesheet" href="${pageContext.request.contextPath}/resources/css/plantilla.css">
...
<div class="form-container">
    <form class="movimientos-form" method="post" action="${pageContext.request.contextPath}/movimientos">
                ...
                <select id="cuentaId" name="cuentaId" required>
                    ...
                    <c:forEach var="cuenta" items="${cuentas}">
                        <option value="${cuenta.id}"
                                ...
                                ${cuenta.nombre} (${cuenta.tipoCuenta}) - Saldo: $<fmt:formatNumber value="${cuenta.monto}" pattern="#,##0.00"/>
                        </option>
                    </c:forEach>
                </select>
        ...
        <div class="form-actions" style="display: flex; gap: 12px;">
            ...
            <a href="${pageContext.request.contextPath}/cuentas" class="btn btn-secondary" style="min-widht: 160px; text-align: center;">
                Cancelar
            </a>
        </div>
    </form>
            ...
            <div class="filters-container">
                <form method="get" action="${pageContext.request.contextPath}/plantillas/buscar" class="filters-form">
                    ...
                    <div class="filter-actions">
                        ...
                        <a class="btn btn-secondary" href="${pageContext.request.contextPath}/movimientos">Limpiar</a>
                    </div>
                </form>
            </div>
